...
export default class EmbedHelper {
  ...
  prepareEmbed(embeds) {
    Object.keys(embeds).forEach((key) => {
      ...
      if (type == "youtube") {
        ...
        preparedEmbed = this.prepareInstagramEmbed(url);
      }
  ...
  getType(embed) {
    if (embed.toString().includes("you")) {
      ...
      return "facebookPost";
    } else if (embed.toString().includes("instagram")) {
      return "instagram";
    }
  }
}
